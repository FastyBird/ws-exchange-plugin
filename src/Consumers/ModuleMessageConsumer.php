...
final class ModuleMessageConsumer implements ApplicationExchangeConsumer\IConsumer
{
	...
	private const ROUTING_KEYS = [
		...
		ModulesMetadata\Constants::MESSAGE_BUS_CONNECTOR_CREATED_ENTITY_ROUTING_KEY,
		ModulesMetadata\Constants::MESSAGE_BUS_CONNECTOR_UPDATED_ENTITY_ROUTING_KEY,
		ModulesMetadata\Constants::MESSAGE_BUS_CONNECTOR_DELETED_ENTITY_ROUTING_KEY,
